    ...
    <div className="absolute flex justify-center items-center w-screen h-full bg-zinc-900">
      ...
      <div className="card relative w-[450px] h-[500px] bg-white rounded-md">
        ...
        <div className="absolute flex justify-center w-[450px] bottom-4">
          <button className="btnDelete w-72 py-2 rounded-full bg-zinc-900 text-center text-white font-medium hover:bg-zinc-700 active:bg-zinc-900" onClick={handleDelete} >
            Clear All
          </button>
        </div>
      </div>
